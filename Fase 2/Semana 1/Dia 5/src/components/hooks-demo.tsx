...
export default function Hooks() {
    ...
    return (
        ...
        <main className="flex gap-8 h-full items-center justify-center">
            ...
            <div className="p-5 flex h-68 w-85 flex-col items-center justify-center bg-blue-950 border-2 rounded-[5px]">

                <h1 className="uppercase font-bold text-3xl mb-6">Incrementador</h1>
            ...
            <div className="p-5 h-68 w-85 flex flex-col items-center justify-center bg-blue-950 border-2 rounded-[5px]">
